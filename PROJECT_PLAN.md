...
| 2 | **Insurance cost vs charge.** **Partly answered 2026-09-17:** the premium depends on the car, so insurance is priced per vehicle rather than at one flat rate. **Answered 2026-09-20:** the cost is whatever the insurer invoices for that car, entered on the policy from their invoice. Built: the policy carries the premium DrivenX pays beside the charge to the customer. | 1D | The policy record carries both a charge and a cost. While the cost is blank, insurance reports as 100% margin and profit is overstated. |
| 3 | **Lease-to-own terms.** **Answered 2026-09-17:** ownership transfers at the end of the term against a final payment of AED 1,000. **Answered 2026-09-20:** early termination is settled case by case — a settlement opens with the arrears already on it and staff add or waive lines. No fixed penalty formula. Built in P2-12. **Still open:** whether VAT applies to the final AED 1,000 buyout payment. | 1D | A one-off `BUYOUT` charge at the end of the schedule. Early termination is a real gap: a customer who stops paying at month 20 of 36 currently has no defined outcome. |
